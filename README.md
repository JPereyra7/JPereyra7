...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,vue,nodejs,nextjs,express,mysql,mongodb,redux,nuxt,sequelize,prisma,tailwind,bootstrap,materialui,powershell,bash,npm,babel,vite,git,netlify,vercel,heroku,html,css,sass,figma,vscode,replit&perline=9)](https://skillicons.dev)
